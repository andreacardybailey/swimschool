...
<section class="main">
  <div class="ss-wrapper">
    <section class="what-to-expect">
      <h1 class="ss-mainhead">What to Expect from Swim Lessons</h1>
      <h2 class="ss-subhead">What should I expect for my child during swimming lessons?</h2>
      <ul class="what-to-expect-list">
       ...
       <li>There may be separation anxiety. If so, the second swim lesson may produce more apprehension than the first. Normally, by the third lesson, the child recognizes the teacher and is becoming comfortable.</li>
