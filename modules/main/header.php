      ...
      <div class="header-preNav">
        <div class="ss-wrapper">
          <div class="header-logo-wrapper">
            <a href="/"><img src="/assets/images/logo.png" alt="Florida Swim School" class="header-logo" /></a>
          </div>
          <aside class="header-generalInfo">
            <img src="/assets/images/seahorse.png" alt="seahorse" class="header-generalInfo-seahorse" />
